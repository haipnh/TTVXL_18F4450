...
INT1 KTNP(); //PROTOTYPE HAM KIEM TRA NHIEU PHIM

//DELAY KET HOP KIEM TRA PHIM
VOID DELAY_KTP(UNSIGNED INT16 DELAY_TIME){
   UNSIGNED INT16 DELAY_TIME2;
   FOR(DELAY_TIME2=0;DELAY_TIME2 < DELAY_TIME;DELAY_TIME2++){
      DELAY_MS(1);
      //HAM KIEM TRA NHIEU PHIM
      IF(KTNP())  BREAK;
   }
}
